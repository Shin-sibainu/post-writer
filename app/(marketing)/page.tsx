...
export default async function IndexPage() {
  return (
    <>
      ...
      <section
        id="features"
        className="container bg-slate-50 py-8 md:py-12 lg:py-24 space-y-6"
      >
        ...
        <div className="mx-auto grid sm:grid-col-2 md:grid-cols-3 gap-4 md:max-w-[64rem]">
            ...
            <div className="flex flex-col justify-between p-6 h-[180px]">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  AppRouter/Layouts/APIRoutes等の技術を使用。
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-background border p-2 rounded-lg">
            <div className="flex flex-col justify-between p-6 h-[180px]">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Server and Client ComponentsとHooksを利用します。
                </p>
              </div>
            </div>
          </div>
